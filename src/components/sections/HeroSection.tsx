...
export default function HeroSection() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 border-b border-border min-h-[560px]">
      {/* LEFT */}
      <div className="flex flex-col justify-between p-8 md:p-14 border-b md:border-b-0 md:border-r border-border">
        <div>
          <ScrollReveal>
            <div className="font-mono text-[8px] tracking-[0.2em] text-accent mb-8">
              FIELD NOTE / 001 — PROJECT: JUNTAKUNA SEIKATSU 2026–
            </div>
          </ScrollReveal>
          <ScrollReveal delay={80}>
            <h1 className="font-mincho text-[38px] md:text-[52px] leading-[1.45] tracking-[0.02em] mb-8">
              未来の暮らしは、<br />
              遠い場所じゃない。<br />
              日々の選択の先にある。
            </h1>
          ...
          <ScrollReveal delay={160}>
            <p className="font-serif text-[17px] leading-[1.9] text-ink-60 max-w-md mb-10">
        ...
        <ScrollReveal delay={320}>
          <div className="flex gap-10 mt-10">
            {[
              ...
              <div key={label}>
                <div className="font-mono text-[12px] tracking-[0.05em] text-ink">{value}</div>
      ...
      {/* RIGHT — Network Graph */}
      <div className="relative flex items-center justify-center p-8 min-h-[380px]">
