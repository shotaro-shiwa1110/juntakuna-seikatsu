          ...
          return (
            <ScrollReveal key={theme.slug} delay={i * 60}>
              <Link
                ...
                className="group block p-10 border-b border-border md:odd:border-r hover:bg-surface transition-colors"
              >
                ...
                <h2 className="font-mincho text-[36px] leading-[1.3] mb-4 group-hover:text-ink-60 transition-colors">
                  {theme.name}
                </h2>
                <p className="font-serif text-[16px] text-ink-60 leading-[1.85] mb-6">{theme.description}</p>
